...
void PushQuadCorners(IDirect3DTexture9* texture, float x, float y, float width, float height,
	float u0, float v0, float u1, float v1, const Corners& colours)
{
...
{
	PushQuadCorners(texture, x, y, width, height, u0, v0, u1, v1,
...
void QuadRenderer::FillRectHorizontal(float x, float y, float width, float height, uint32_t left,
	uint32_t right)
{
	FillRectCorners(x, y, width, height, left, right, left, right);
}

void QuadRenderer::FillRectCorners(float x, float y, float width, float height, uint32_t topLeft,
	uint32_t topRight, uint32_t bottomLeft, uint32_t bottomRight)
{
	PushQuadCorners(nullptr, x, y, width, height, 0.0f, 0.0f, 1.0f, 1.0f,
