...
namespace QuadRenderer
{
	...
	void FillRectHorizontal(float x, float y, float width, float height, uint32_t left, uint32_t right);

	void FillRectCorners(float x, float y, float width, float height, uint32_t topLeft, uint32_t topRight,
