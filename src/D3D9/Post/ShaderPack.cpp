...
void WriteReadme()
{
	const char* const text =
		...
		"  .glsl          libretro, Shadertoy, or plain OpenGL GLSL\r\n"
		...
		"    annotations, textures, samplers, and techniques made of passes, which ReShade's own runtime\r\n"
		"    resolves before anything is compiled. The maths inside the pass is fine; everything around it\r\n"
		"    has to be answered by something.\r\n"
		"  - A libretro .slang is Vulkan GLSL, and a .glsl is OpenGL GLSL. Direct3D cannot compile GLSL at\r\n"
		"    all. RetroArch runs them through a compiler chain of its own, and a preset usually chains\r\n"
		"    several of them together.\r\n"
		"\r\n"
		"So a shader from either world cannot be handed to D3D9 as it stands. The mod rewrites it instead:\r\n"
		"uniforms become their default values, samplers become the frame, the resolution and time uniforms\r\n"
		"become the two constants below, and the GLSL is rewritten as HLSL. The alternative is shipping a\r\n"
		"full effect runtime - a GLSL compiler, multi-pass rendering, its own render targets - which is\r\n"
		"ReShade and RetroArch, not a training mod.\r\n"
		"\r\n"
		...
		"wrong. The big multi pass CRT shaders - crt-royale, crt-guest-advanced, most of libretro's crt/\r\n"
		"folder - are exactly that, and they will not survive the trip. The single pass ones do.\r\n"
		"\r\n"
		"\r\n"
		"WHERE TO GET SHADERS\r\n"
		"\r\n"
		"  ReShade      reshade.me, and github.com/crosire/reshade-shaders (folder: Shaders). Download the\r\n"
		"               raw .fx file. The single pass ones land: colour grades, grain, vignettes, tone maps.\r\n"
		"               A .fx that needs a .fxh of its own beyond ReShade.fxh will not, because the include\r\n"
		"               is dropped.\r\n"
		"\r\n"
		"  libretro     github.com/libretro/slang-shaders. Download the raw .slang. Its handheld/ and misc/\r\n"
		"               folders are full of single pass files. Ignore the .slangp preset files - a preset is\r\n"
		"               a chain of passes and there is nothing here to chain.\r\n"
		"\r\n"
		"  Shadertoy    shadertoy.com. Copy the code out of the editor, save it as a .glsl, and drop it in.\r\n"
		"               Anything that only reads iChannel0 as the screen works. Anything that wants a Buffer\r\n"
		"               A, a texture, or a cubemap does not.\r\n"
		"\r\n"
		"There is no library of packs written for this mod specifically. What is here is the eighteen\r\n"
		"examples below.\r\n"
		"\r\n"
		"\r\n"
		...
		"             BUFFER_SCREEN_SIZE, BUFFER_ASPECT_RATIO, ReShade::BackBuffer, ReShade::PixelSize and\r\n"
		"             ReShade::ScreenSize. A uniform becomes its default value, and one with a source of\r\n"
		...
		"             mainImage is called with fragCoord in pixels, y up, the way Shadertoy has it\r\n"
		...
		"after it:\r\n"
		"\r\n"
		"  13_reshade_tonemap.fx     ReShade: annotated uniforms, a sampler and a technique\r\n"
		"  14_slang_scanlines.slang  libretro: #pragma parameters, a UBO, two stages\r\n"
