...
"     New: pick a file of your own from anywhere on your computer.",
"     Back to original: undo that one change so the game's own sound plays again.",
"",
...
"",
"",
"A WHOLE VOICE FROM UNI, OR FROM A VOICE MOD",
"------------------------------------------",
"",
"The same tab has \"Get this voice from UNI or a mod...\", and two things fit in it.",
"",
"Point it at your own copy of the older game (the folder holding UNIclr.exe, UNIst.exe or",
"UNIEL.exe) and the mod copies that character's voice out of it: the battle lines, the win",
"quotes and the story lines.",
"",
...
"",
"What it takes becomes a new pack in Sounds, named after the character and the game it came",
"from, and only that character wears it. The pack box beside the character switches back to",
"the game's own voice at any time. Nothing is deleted, and running the import again replaces",
"what it added instead of doubling it.",
"",
...
"",
"The other thing that fits is a voice mod somebody made for this game, the kind whose",
"instructions say to drop its folders into the game folder next to uni2.exe. Point the same",
"button at the folder you unzipped and the mod takes that character's sounds out of its se",
"folder for you, so nothing of yours is overwritten and the game folder is left alone. It",
"lands as its own pack named after the folder, and the pack box turns it off again whenever",
"you like. Only the character chosen above is taken, so a mod covering several characters is",
"imported once per character.",
"",
"",
...
"does not name a character, like the story lines under se\\talk. Leave it out and",
...
"the engine only reads a WAV out of its own archive. A loose WAV stays silent. The name you",
...
"goes the same way, since it is a pack like any other.",
"",
};
