...
const char* const kReadme =
	...
	"==============\r\n"
	"\r\n"
	"Drop MP3, OGG Vorbis or WAV files in here and the mod loads them when the game starts. No\r\n"
	"tools and nothing to edit. Loose files work, and so does a folder per pack. The folder name\r\n"
	...
	"or FLAC instead of Vorbis is the one thing that cannot be read. Convert it to Vorbis or\r\n"
	"MP3.\r\n"
	"\r\n"
