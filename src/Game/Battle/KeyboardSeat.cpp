...
GameHook<PadUpdateFn> g_padUpdateHook("PadUpdate");
...
bool KeyboardSeat::Initialize()
{
	...
	if (target == nullptr || !g_padUpdateHook.Install(target, &HookedPadUpdate))
	{
