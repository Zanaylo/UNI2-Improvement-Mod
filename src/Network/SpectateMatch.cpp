...
bool RunSetup(int32_t* block)
{
	__try
	{
		reinterpret_cast<MatchSetupFn>(RvaToAddress(GameOffsets::kFnRankMatchSetup))();
		reinterpret_cast<ApplyBlockFn>(RvaToAddress(GameOffsets::kFnApplyMatchBlock))(block);
	}
