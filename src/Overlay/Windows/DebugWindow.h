...
private:
	...
	static constexpr int kMaxEntities = GameOffsets::kCharaArrayCount;
	static constexpr DWORD kRefreshIntervalMs = 250;
	...
	void* m_entities[kMaxEntities] = {};
	int m_entityCount = 0;
	DWORD m_lastRefreshTick = 0;
	EntityRow m_entityRows[kMaxEntities] = {};
