These pages are the GitHub wiki. This folder is the source; the wiki is a copy.
...
To publish by hand, with the workflow off or before the first push: the **Actions** tab has **Wiki**
